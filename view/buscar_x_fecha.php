<?php
	...
	$mensaje;
		...
		if ($dia != "" and $mes != "" and $year != "") {
			$fecha = $year."-".$mes."-".$dia;
			$sql   = "SELECT cod_sct, cod_not, num_sct, cod_dst, fec_doc, cod_sub, nom_bie, can_fol, cod_pro, obs_sct, num_fol, proy_id FROM dbarp2.escrituras1 WHERE fec_doc ='$fecha'";
		...
		if ($dia == "" and $mes == 0) {
			$fecha = $year."-"."%"."-"."%";
			$sql   = "SELECT cod_sct, cod_not, num_sct, cod_dst, fec_doc, cod_sub, nom_bie, can_fol, cod_pro, obs_sct, num_fol, proy_id FROM dbarp2.escrituras1 WHERE fec_doc LIKE '$fecha'";
    	...
    	<div class="row">
			<div class="col-md-12">
				...
				<form method="post">
					...
					<div class="col-md-3"><input name="buscar" type="submit" id="buscar" value="Buscar" class="btn btn-primary form-control" /></div>
				</form>
			</div>
		</div>
	  </div>
